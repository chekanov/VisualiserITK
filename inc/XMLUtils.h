...
namespace InDet {
  ...
  public:
    ...
    void ATH_MSG_WARNING(std::string s) { cout << s << endl;}
    void ATH_MSG_DEBUG(std::string s) { cout << s << endl;}
    void ATH_MSG_INFO (std::string s) { cout << s << endl;}
    void ATH_MSG_ERROR (std::string s) { cout << s << endl;}
