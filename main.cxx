...
TGeoMedium *Ts = new TGeoMedium("Ts",12,12,0,0,0,20,0.1000000E+11,0.212,0.1000000E-02,1.150551);
    ...
    XMLReaderSvc reader("ATLAS-P2-ITK-16-00-00");
    reader.initialize();
   ...
   cout << "Write out/itkgeom.root" << endl;
   TFile* f = TFile::Open("out/itkgeom.root","recreate");
...
// this is fall-back solution, should work with most ROOT versions
   ...
   std::ofstream ofs("out/itkgeom.json");
   ofs << json.Data();
   ofs.close();

   // gGeoManager->Export("out/itkgeom.root");
   gGeoManager->SaveAs("out/itkgeom.png");
